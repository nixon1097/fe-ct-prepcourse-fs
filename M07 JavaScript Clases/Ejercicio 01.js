...
function agregarStringInvertida() {
   ...
   String.prototype.reverse = function() {
       let stringSplit =this.split("");// separa un string y lo convierte en un array letra por letra cuando no se le coloca ningun valor 
       let arrayReverse=  stringSplit.reverse(); // lo devuelve alreves 
       let arrayjoin= arrayReverse.join(""); // los junta
       return arrayjoin;
